...
export default function App() {
  ...
  const handleFileA = (e) => {
    ...
    reader.onload = (event) => {
      console.log("File A loaded:", event.target.result);
      setTextA(event.target.result);
    };
  ...
  const handleFileB = (e) => {
    ...
    reader.onload = (event) => {
      console.log("File B loaded:", event.target.result);
      setTextB(event.target.result);
    };
  ...
  const loadHistory = async () => {
    try {
      ...
      setError(
        "Could not connect to backend server. Running in fallback mode.",
      );
    }
  };
        ...
        <main className="workspace">
          ...
          <div className="glass-panel control-panel">
            ...
            >
              ...
              >
                ...
                <option value="histogram">
                  Histogram Diff (Line Text - Patience extension)
                </option>
                ...
                <div>
                  ...
                  >
                    <span className="editor-label">
                      Original Content (File A)
                    </span>

                    <input
                      type="file"
                      accept=".txt,.cpp,.c,.java,.py,.js,.ts"
            ...
            <div className="actions-bar">
              <span style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>
                Note: GumTree works best with simple C-like program code or
                S-expressions, and falls back to word-indented trees for text.
              </span>
              <button
                onClick={runDiff}
          ...
          {loading && (
            <div className="glass-panel empty-state">
              <div
                className="logo-icon pulse-border"
                style={{
                  width: "40px",
                  height: "40px",
                  borderRadius: "50%",
              ...
              <span style={{ fontSize: "0.9rem" }}>
                Calling C++ diff engine and generating outputs...
              </span>
            </div>
          )}
            ...
            <div className="glass-panel empty-state">
              ...
              <div>
                ...
                <p style={{ fontSize: "0.875rem", color: "var(--text-muted)" }}>
                  Setup your files and click "Run Diff Engine" or select a past
                  run from history.
                </p>
              </div>
            </div>
