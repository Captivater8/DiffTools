            ...
            <div className="viz-header">
                ...
                <div className="diff-view-mode">
                    <button 
                        ...
                        style={{ padding: '0.4rem 0.8rem', display: 'flex', gap: '0.4rem', borderTopRightRadius: 0, borderBottomRightRadius: 0 }}
                    >
                        <Columns size={16} />
                        Split
                    </button>
                    <button 
                        ...
                        style={{ padding: '0.4rem 0.8rem', display: 'flex', gap: '0.4rem', borderTopLeftRadius: 0, borderBottomLeftRadius: 0, borderLeft: 0 }}
                    >
                        <Eye size={16} />
                        Unified
                    </button>
            ...
            {viewMode === 'unified' ? (
                    ...
                    <table className="diff-table">
                        <tbody>
                            {diff.map((item, idx) => {
                                ...
                                const rowClass = isInsert ? 'diff-insert' : isDelete ? 'diff-delete' : 'diff-equal';
                ...
                <div className="split-diff-container">
                    ...
                    <div className="split-pane">
                        ...
                        <div className="diff-content" style={{ border: 0, borderRadius: 0 }}>
                            <table className="diff-table">
                                <tbody>
                                        ...
                                        if (!item) {
                                            return (
                                                <tr key={idx} className="diff-row diff-empty">
                                                    <td className="diff-cell-num" style={{ borderRight: 0 }}></td>
                                                    <td className="diff-cell-content" style={{ minHeight: '22px' }}>&nbsp;</td>
                                                </tr>
                                            );
                                        }
                                        return (
                                            <tr key={idx} className="diff-row diff-delete">
                                                <td className="diff-cell-num">{item.lineNoA}</td>
                                                <td className="diff-cell-content">
